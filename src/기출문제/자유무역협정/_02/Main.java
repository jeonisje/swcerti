...
class UserSolution {	
	...
	public void init(int numA, char[][] listA, int numB, char[][] listB) {
		 ...
		 project = new int[companyCount+1][companyCount+1];
	...
	public int conflict(char[] mCompany1, char[] mCompany2) {
		...
		for(int projects: project[pSeq1]) { }
		/*
...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		System.setIn(new java.io.FileInputStream("C:\\sw certi\\workspace\\swcerti\\src\\기출문제\\자유무역협정\\sample_input2.txt"));
