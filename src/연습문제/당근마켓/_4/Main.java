...
class UserSolution {
	...
	public int sellCarrot(String tag1, String tag2, String tag3) {
		...
		ArrayList<Integer> list1 = (ArrayList<Integer>) tagMap.get(findTags[0]).stream().collect(Collectors.toList());
		//Collections.copy(tagMap.get(findTags[0]), list1);
		
		ArrayList<Integer> list2 = tagMap.get(findTags[1]);
		ArrayList<Integer> list3 = tagMap.get(findTags[2]);
